...
class LipidProfileRepository {
  ...
  Future<List<Map<String, dynamic>>> getLipidProfileDetail(
    ...
    final url = Uri.parse(
        'https://api.diavan-valuation.asia/api/HealthIndicator/healthIndicator/lipid-profile/detail/$id');
        ...
        if (data["status"] == 1) {
          ...
          return heightData.map((item) {
            return {
              ...
              "ldlcholesterolAverage": item["ldlcholesterolAverage"],
              "hdlcholesterolAverage": item["hdlcholesterolAverage"],
              "triglyceridesAverage": item["triglyceridesAverage"],
