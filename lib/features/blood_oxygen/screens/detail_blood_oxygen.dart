...
class DetailBloodOxygen extends ConsumerStatefulWidget {
...
class _DetailBloodOxygenState extends ConsumerState<DetailBloodOxygen>
  ...
  Color getBMIColor(String? result) {
    if (result?.trim().toLowerCase() == "thấp") {
      return Colors.red;
    } else if (result?.trim().toLowerCase() == "tốt") {
      return Colors.green; // Bình thường
    } else if (result?.trim().toLowerCase() == "cao") {
      return Colors.blue;
    } else {
