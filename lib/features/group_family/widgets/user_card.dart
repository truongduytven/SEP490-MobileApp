...
//   final Function(int, int)? onRemoveMember; // Thêm callback xóa thành viên
...
//     this.onRemoveMember, // Thêm tham số này
//   }) : super(key: key);

//   @override
//   Widget build(BuildContext context) {
//     final bool isCurrentUser = user['accountId'] == currentUserAccountID;
//     final bool canRemove = currentRoleID == 3 && !isCurrentUser;
...
//         content: Text(
//           'Bạn có chắc chắn muốn xóa ${user['fullName']} khỏi nhóm?',
...
//     if (confirmed == true) {
//       await _removeMember(context, user['accountId'], groupId);
//     }
//   }
...
//     try {
//       final url =
//           'https://api.diavan-valuation.asia/groups/$groupId/members/$currentUserAccountID/$memberId';
...
//         if (data['status'] == 1) {
//           CherryToast.success(
//             title: Text('Đã xóa ${user['fullName']} khỏi nhóm'),
