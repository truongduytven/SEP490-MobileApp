...
class DetailCaloriesBurnedScreen extends ConsumerStatefulWidget {
  const DetailCaloriesBurnedScreen({super.key});

  @override
  ConsumerState<DetailCaloriesBurnedScreen> createState() =>
