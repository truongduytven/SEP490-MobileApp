...
class _PrescriptionScreenState extends State<PrescriptionScreen> {
  PrescriptionUpdate? prescription;
  ...
  void getPrescription() async {
    ...
    Timer(Duration(seconds: 2), () {
      setState(() {
        prescription = medicineController.prescriptionUpdate;
        isLoading = false;
      });
    });
  }
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      'Toa thuốc ngày ${convertDate(prescription!.startDate)}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 22),
                                    )),
