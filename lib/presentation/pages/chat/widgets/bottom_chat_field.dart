...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void selectGIF() async {
    ...
    if (gif == null) {
      // showSnackBar(context: context, content: "No GIF selected.");
      return;
    }
    ...
    if (gifUrl == null || gifUrl.isEmpty) {
      // showSnackBar(context: context, content: "Failed to get GIF URL.");
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isShowMessagReply = messageReply != null;
    return Column(
      children: [
